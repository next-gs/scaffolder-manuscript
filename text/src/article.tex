...
programs such as newbler\cite{newbler} or abyss\cite{abyss}. Scaffolder then
the contig to be selected by specifying the name of the contig in the scaffold
file. The scaffold file also allows a sub-sequence or the reverse complement of
a contig to used. This therefore preserves the original sequence data but also
allowing sequences to manipulated in the final genome build.
