...
\title{Scaffolder - Simple and reproducible genome scaffolding using
...
\begin{abstract}
  ...
  reproducible and comparatively easier to edit than raw fasta sequence.
  ...
  a genome. Scaffolder can be found at http://michaelbarton.me.uk/sfdr.
