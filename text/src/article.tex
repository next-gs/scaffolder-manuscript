...
in YAML \cite{yaml}. YAML is a language format for data using whitespace and
identation to produce a machine readable structure. As a standardised data
...
additon to being computationally tractable. This requirement for the scaffold
files to be modifable in a simple simple text editor is the second reason YAML
