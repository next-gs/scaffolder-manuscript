...
The genome scaffold is written in YAML format. YAML is a data format designed
...
sequence should be inserted into the scaffold. This sequence is identified by
...
entry in the scaffold. The following entry is identified by the ``unresolved''
...
used to identify which fasta sequence entry should be used as the insert.  The
...
replacing the coordinate nucleotides. The open and close positions need not be
