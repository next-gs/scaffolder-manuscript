...
used to probabalistically estimate the order and distance between these
...
reads can result in the assembly collapsing into an artifically short sequence
...
processmay require moving and editing large blocks of nucleotide text by hand
...
the possibility of irreporducible techniques and/or human error. The aims of
