...
\section*{Availability and Requirements} %{{{1
  ...
  \begin{description}
    ...
    software and the following libraries: BioRuby \add{1.4.x}, confligliere
    \add{0.1.x}\add{, ronn 0.7.x}. A full list of development dependencies
    can be found in the Gemfile in the base directory of each project.}
    \item[License:] MIT
