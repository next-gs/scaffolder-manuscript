...
accessable to the many languages which provide parsers to this format. The
...
\add{The example use case for scaffolder is a combination of compuation and
...
makes scaffold files \add{ameniable} to storage in version control systems and
